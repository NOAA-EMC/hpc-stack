...
setenv("LANDSFCUTIL_LIB4", pathJoin(base,"${CMAKE_INSTALL_LIBDIR}/liblandsfcutil_4.a"))
setenv("LANDSFCUTIL_LIBd", pathJoin(base,"${CMAKE_INSTALL_LIBDIR}/liblandsfcutil_d.a"))
