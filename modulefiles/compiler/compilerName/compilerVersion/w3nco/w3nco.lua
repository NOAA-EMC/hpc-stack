...
setenv("W3NCO_LIB4", pathJoin(base,"${CMAKE_INSTALL_LIBDIR}/libw3nco_4.a"))
setenv("W3NCO_LIB8", pathJoin(base,"${CMAKE_INSTALL_LIBDIR}/libw3nco_8.a"))
setenv("W3NCO_LIBd", pathJoin(base,"${CMAKE_INSTALL_LIBDIR}/libw3nco_d.a"))
